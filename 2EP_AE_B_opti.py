...
def two_EP_ae_b(params, ns):
    ...
    """
    nu_ae,nu1,nu2,s,Tae,T1,T2,m12a,m21a,m12b,m21b = params
    nu2_0 = nu1*s
...
for i in range(2,6):
	...
	Optimize_Functions.Optimize_Routine(data, prefix, "two_EP_ae_b", two_EP_ae_b, 3, 11, data_folded=True, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)

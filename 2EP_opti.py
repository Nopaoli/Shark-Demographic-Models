...
def two_EP(params, ns):
    ...
    """
    nu1,nu2,T1,T2,m12a,m21a,m12b,m21b = params
...
p_labels = "nu1,nu2,T1,T2,m12a,m21a,m12b,m21b"
upper = [20,20,10,10,100,100,100,100]
...
for i in range(4,6):
	...
	Optimize_Functions.Optimize_Routine(data, prefix, "two_EP", two_EP, 3, 8, data_folded=True, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)

...
for i in range(4,6):
	...
	Optimize_Functions.Optimize_Routine(data, prefix, "SC_ae", SC_ae, 3, 8, data_folded=True, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)
